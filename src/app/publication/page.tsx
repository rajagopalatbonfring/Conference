...
// This is a Server Component → can export metadata

import { Metadata } from 'next';
import ClientContent from './ClientContent';

export const metadata: Metadata = {
  title: 'Publication & Proceedings ICLEAS 2026 | Indexed Conference Papers & Journal Opportunities',
  description: 'Publish your research with ICLEAS 2026 – official ISBN/DOI proceedings indexed in Google Scholar, CrossRef, DOAJ + extended publication in Scopus/SCI journals. Peer-reviewed, high-visibility opportunities in life sciences, environmental sciences, biotechnology & sustainability.',
  keywords: 'ICLEAS 2026 proceedings, conference publication opportunities, Scopus indexed journals, life sciences publication, environmental science journal, biotechnology conference papers, indexed conference proceedings 2026',
};
