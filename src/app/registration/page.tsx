...
export const metadata: Metadata = {
  title: 'Registration ICLEAS 2026 | Conference Fees & Early Bird Discounts',
  description: 'Register now for ICLEAS 2026 – online international conference on life sciences, environmental sciences, applied sciences, biotechnology & sustainability. Early bird rates until April 30, 2026. Student, academic & industry categories available.',
  keywords: 'ICLEAS 2026 registration, conference fees 2026, early bird discount ICLEAS, student registration life sciences conference, academic registration environmental sciences, industry registration biotechnology conference, online conference registration',
};
