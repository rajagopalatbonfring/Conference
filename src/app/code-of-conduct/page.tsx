...
// Fully static page – metadata can live here directly
...
export const metadata: Metadata = {
  title: 'Code of Conduct ICLEAS 2026 | Safe & Inclusive Conference Environment',
  description: 'Read the Code of Conduct for ICLEAS 2026 – international online conference on life, environmental & applied sciences. We are committed to a harassment-free, respectful, and inclusive experience for all participants, speakers, organizers, and attendees.',
  keywords: 'ICLEAS 2026 code of conduct, conference code of conduct, safe conference environment, harassment-free policy ICLEAS, inclusive conference guidelines, ScientiaForum code of conduct',
};

export default function CodeOfConductPage() {
  return (
    <div className="flex flex-col bg-white">
      {/* Hero Section – your exact original design + SEO text tweak */}
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-emerald-950 via-teal-900 to-green-950">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(52,211,153,0.2),rgba(255,255,255,0))]"></div>
        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-2 text-emerald-200 mb-8 justify-center">
              <span className="hover:text-white cursor-pointer transition-colors">Home</span>
              <ChevronRight className="w-4 h-4" />
              <span className="text-white font-medium">Code of Conduct ICLEAS 2026</span>
            </div>
            
            <div className="text-center space-y-6">
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-rose-500/20 backdrop-blur-sm border border-rose-400/30 mb-4">
                <Heart className="w-5 h-5 text-rose-300" />
                <span className="text-sm text-rose-200 font-bold uppercase tracking-wider">Safe & Inclusive Conference</span>
              </div>
              ...
              <p className="text-lg md:text-xl text-teal-100 leading-relaxed max-w-3xl mx-auto">
                Our commitment to a harassment-free, respectful, and inclusive environment for all participants at ICLEAS 2026
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Content Section – your exact original structure + SEO-friendly text */}
      <section className="bg-gradient-to-b from-white to-emerald-50 py-24 md:py-32">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-16">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-emerald-100">
                <p className="text-lg text-slate-700 leading-relaxed">
                  The organizers of ICLEAS 2026 (ScientiaForum) are dedicated to providing a safe, welcoming, harassment-free, and inclusive conference experience for everyone, regardless of gender, gender identity and expression, age, sexual orientation, disability, physical appearance, body size, race, ethnicity, nationality, religion (or lack thereof), or technology choices. We do not tolerate harassment or discriminatory behavior in any form.
                </p>
              </div>
            </div>
            ...
            <div className="mb-16">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-teal-100 space-y-6">
                <p className="text-lg text-slate-700 leading-relaxed">
                  All participants (attendees, authors, speakers, reviewers, committee members, sponsors, volunteers) are expected to behave respectfully and professionally throughout the conference. This includes:
                </p>
                
                <div className="space-y-4">
                  {[
                    "Communicating courteously and professionally in all interactions (virtual sessions, chats, emails, etc.)",
                    "Respecting diverse viewpoints, backgrounds, and experiences",
                    "Being mindful of language and behavior to avoid offense",
                    "Refraining from any form of intimidation, harassment, discrimination, or abusive conduct"
                  ].map((item, idx) => (
                    <div key={idx} className="flex items-start gap-4 p-4 bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl border border-teal-100">
                      <p className="text-slate-700 leading-relaxed pt-0.5">{item}</p>
                    </div>
            ...
            <div className="mb-16">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-red-100 space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    "Offensive verbal or written comments related to gender, sexual orientation, race, religion, disability, appearance, or other protected characteristics",
                    "Deliberate intimidation, stalking, following, or unwanted attention",
                    "Use of sexualized images, language, or inappropriate sexual attention in any conference context",
                    "Disruption of talks, sessions, or other conference events",
                    "Advocacy of or encouragement of any of the above behaviors"
                  ].map((item, idx) => (
                    <div key={idx} className="flex items-start gap-4 p-4 bg-gradient-to-br from-red-50 to-rose-50 rounded-xl border border-red-200">
                      <p className="text-slate-700 leading-relaxed pt-0.5">{item}</p>
                    </div>
            ...
            <div className="mb-16">
              <div className="flex items-center gap-3 mb-6">
                <h2 className="text-3xl font-bold text-slate-900">Reporting Incidents</h2>
              </div>
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-8 shadow-lg border-2 border-amber-200">
                <div className="space-y-6">
                  <p className="text-lg text-slate-700 leading-relaxed">
                    If you experience, witness, or have concerns about harassment or any violation of this Code of Conduct during ICLEAS 2026, please report it immediately to the conference team. All reports will be treated confidentially and handled promptly and seriously.
                  </p>
                  ...
                  <div className="flex items-center gap-4 p-6 bg-white rounded-xl border border-amber-200">
                    ...
                    <div>
                      <p className="text-sm text-slate-600 mb-1">Report to:</p>
                      <a 
                        href="mailto:conduct@icleas2026.org" 
                        className="text-xl font-bold text-amber-700 hover:text-amber-800"
                      >
                        conduct@icleas2026.org
                      </a>
                    </div>
                  </div>
                </div>
            ...
            <div className="mb-16">
              <div className="flex items-center gap-3 mb-6">
                <h2 className="text-3xl font-bold text-slate-900">Consequences of Violations</h2>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100">
                <p className="text-lg text-slate-700 leading-relaxed">
                  Participants asked to stop harassing or unacceptable behavior are expected to comply immediately. If a participant continues to engage in such behavior, the conference organizers may take any action deemed appropriate, including warning the offender, removal from the virtual platform, expulsion from the conference without refund, and/or reporting to relevant authorities or institutions.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-600 to-teal-600 rounded-3xl p-8 md:p-12 text-white">
              <div className="flex items-start gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-xl text-emerald-100 mb-6 leading-relaxed">
                    We are dedicated to making ICLEAS 2026 a safe, respectful, and inclusive experience for all participants. By registering or attending, you agree to uphold this Code of Conduct and contribute to a positive environment for everyone.
                  </p>
                  <div className="flex flex-wrap gap-4">
                    <a 
                      href="mailto:conduct@icleas2026.org"
