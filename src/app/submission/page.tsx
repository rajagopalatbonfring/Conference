...
export const metadata: Metadata = {
  title: 'Paper Submission ICLEAS 2026 | Submit Research to International Conference',
  description: 'Submit your original research paper to ICLEAS 2026 – online international conference on life sciences, environmental sciences, applied sciences, biotechnology & sustainability. Email submissions to submissions@icleas.com. Deadline: March 31, 2026. Double-blind peer review, indexed proceedings.',
  keywords: 'ICLEAS 2026 paper submission, submit research paper ICLEAS, conference paper submission guidelines, life sciences conference submission, environmental sciences paper submission, biotechnology conference call for papers, online conference submission 2026',
};
