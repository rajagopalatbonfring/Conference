...
export const metadata: Metadata = {
  title: 'Refund Policy ICLEAS 2026 | Registration Cancellation & Refund Terms',
  description: 'Read the official refund policy for ICLEAS 2026 – international online conference on life, environmental & applied sciences. Full refund (minus $50 fee) available for cancellations before May 25, 2026. No refunds after deadline or for no-shows.',
  keywords: 'ICLEAS 2026 refund policy, conference registration refund, cancellation policy ICLEAS, registration refund deadline May 2026, no-show policy conference, ScientiaForum refund terms',
};
        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-2 text-emerald-200 mb-8 justify-center">
              <span className="hover:text-white cursor-pointer transition-colors">Home</span>
              <ChevronRight className="w-4 h-4" />
              <span className="text-white font-medium">Refund Policy ICLEAS 2026</span>
            </div>
            
            <div className="text-center space-y-6">
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-green-500/20 backdrop-blur-sm border border-green-400/30 mb-4">
                <DollarSign className="w-5 h-5 text-green-300" />
                <span className="text-sm text-green-200 font-bold uppercase tracking-wider">Registration Refunds & Cancellations</span>
              </div>
      ...
      <section className="bg-gradient-to-b from-white to-emerald-50 py-24 md:py-32">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-16">
              <div className="flex items-center gap-3 mb-6">
                <h2 className="text-3xl font-bold text-slate-900">1. General Refund Policy</h2>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-emerald-100">
                <p className="text-lg text-slate-700 leading-relaxed">
                  This refund policy applies to all registration fees paid for ICLEAS 2026, the International Conference on Life, Environmental & Applied Sciences, organized by ScientiaForum. All requests must be submitted in writing to{' '}
                  <a href="mailto:registration@icleas2026.org" className="text-teal-600 font-semibold hover:text-teal-700">
                    registration@icleas2026.org
                  </a>.
                </p>
              </div>
            </div>
            ...
            <div className="mb-16">
              <div className="flex items-center gap-3 mb-6">
                <h2 className="text-3xl font-bold text-slate-900">2. Cancellation by Participant</h2>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-teal-100 space-y-6">
                <p className="text-lg text-slate-700 leading-relaxed">
                  Refund requests must be submitted in writing to the registration team. Refunds are processed according to the following schedule:
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-200">
                    <div className="flex items-start gap-4">
                      <div>
                        <h3 className="text-xl font-bold text-slate-900 mb-2">Full Refund (Minus Fee)</h3>
                        <p className="text-slate-700 leading-relaxed">
                          Requests received on or before <strong>May 25, 2026</strong> are eligible for a full refund minus a <strong>$50 administrative processing fee</strong>.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6 border-2 border-amber-200">
                    <div className="flex items-start gap-4">
                      <div>
                        <h3 className="text-xl font-bold text-slate-900 mb-2">No Partial Refunds</h3>
                        <p className="text-slate-700 leading-relaxed">
                  ...
                  <div className="bg-gradient-to-br from-red-50 to-rose-50 rounded-xl p-6 border-2 border-red-200">
                    <div className="flex items-start gap-4">
                      <div>
                        <h3 className="text-xl font-bold text-slate-900 mb-2">No Refund After Deadline</h3>
                        <p className="text-slate-700 leading-relaxed">
                          Requests received after <strong>May 25, 2026</strong> are not eligible for any refund.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="mb-16">
              <div className="flex items-center gap-3 mb-6">
                <h2 className="text-3xl font-bold text-slate-900">3. Non-Attendance / No-Show</h2>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-red-100">
                <p className="text-lg text-slate-700 leading-relaxed">
                  No refunds will be issued for non-attendance, failure to join sessions, or no-shows during ICLEAS 2026.
                </p>
              </div>
            </div>

            {/* 4. Conference Cancellation */}
            <div className="mb-16">
              <div className="flex items-center gap-3 mb-6">
                <h2 className="text-3xl font-bold text-slate-900">4. Conference Cancellation by Organizers</h2>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-blue-100">
                <p className="text-lg text-slate-700 leading-relaxed">
                  In the unlikely event that ICLEAS 2026 is cancelled by the organizers (ScientiaForum), all paid registration fees will be fully refunded to participants within 30 days.
                </p>
              </div>
            </div>
            ...
            <div className="mb-16">
              <div className="flex items-center gap-3 mb-6">
                <h2 className="text-3xl font-bold text-slate-900">5. Refund Processing Time</h2>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100">
                <p className="text-lg text-slate-700 leading-relaxed">
                  All approved refund requests will be processed within <strong>30 calendar days</strong> after the conclusion of ICLEAS 2026 or after approval (whichever is later).
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-600 to-teal-600 rounded-3xl p-8 md:p-12 text-white">
              <div className="flex items-start gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-xl text-emerald-100 mb-4 leading-relaxed">
                    For any refund-related inquiries or to submit a cancellation request, please contact our registration team at:
                  </p>
                  <a 
                    href="mailto:registration@icleas2026.org" 
                    className="inline-flex items-center gap-2 px-6 py-3 bg-white text-emerald-900 rounded-xl font-bold text-lg hover:bg-emerald-50 transition-all"
                  >
                    <Mail className="w-5 h-5" />
                    registration@icleas2026.org
