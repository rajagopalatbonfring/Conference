...
export default function ClientContent() {
  ...
  // Dummy array just to keep tabs UI working (you can remove count later if you want)
  const tabItems = [
    { title: "Chief Patron", icon: Crown, count: 0 },
    { title: "Conference Chair", icon: Award, count: 0 },
    { title: "Co-Chairs", icon: Users, count: 0 },
    { title: "Program Chair", icon: Briefcase, count: 0 },
    { title: "Organizing Committee", icon: UserCog, count: 0 },
    { title: "Technical / Review Committee", icon: Shield, count: 0 },
  ];

  const ActiveIcon = tabItems[activeTab].icon;
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Main Content Area – replaced member grid with coming soon banner */}
      <section className="relative container mx-auto px-4 py-16 md:py-24">
        {/* Tabs Navigation – kept exactly the same (visual consistency) */}
        <section className="absolute -top-8 z-30">
          <div className="container mx-auto p-2 bg-black/5 backdrop-blur-xl border border-gray-600/20 shadow-sm rounded-full overflow-hidden">
            <div className="flex overflow-x-auto scrollbar-hide">
        ...
        {/* Coming Soon Banner – centered, matches site aesthetic */}
        <div className="mt-20 mb-12">
          <div className="bg-gradient-to-br from-emerald-50 via-teal-50 to-white rounded-3xl p-10 md:p-16 shadow-xl border border-emerald-100/60 text-center relative overflow-hidden max-w-5xl mx-auto">
            {/* Decorative blobs */}
            <div className="absolute -top-24 -right-24 w-80 h-80 bg-emerald-100/40 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-24 -left-24 w-80 h-80 bg-teal-100/40 rounded-full blur-3xl"></div>

            <div className="relative">
              <div className="inline-flex items-center justify-center w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-emerald-100 to-teal-100 text-emerald-700 mx-auto mb-8 shadow-inner">
              ...
              <p className="text-lg md:text-xl text-slate-700 leading-relaxed max-w-3xl mx-auto mb-10">
                The full list of distinguished committee members for ICLEAS 2026 is currently being finalized. 
                World-class researchers, professors, and experts from top institutions will be announced here shortly.
              </p>

              <p className="mt-10 text-slate-500 text-lg italic">
                Exciting announcements coming soon • Stay tuned!
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Join the Team CTA – completely unchanged */}
      <section className="relative bg-gradient-to-br from-emerald-50 to-teal-50 py-20 border-y border-emerald-100">
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-emerald-200 rounded-full mb-6 shadow-sm">
